...
for file_name in csv_files:
    ...
    random_search_gb = RandomizedSearchCV(model_gb, param_distributions_gb, n_iter=100, scoring=mcc_scorer, cv=5, random_state=42)
...
output_file_path = "./gradientboosting_feature_CPP_embedding.csv"
