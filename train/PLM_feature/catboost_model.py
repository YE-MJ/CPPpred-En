...
for file_name in csv_files:
    ...
    random_search_cat = RandomizedSearchCV(model_cat, param_distributions_cat, n_iter=100, scoring=mcc_scorer, cv=5, random_state=42)
...
output_file_path = "./catboost_feature_CPP_embedding.csv"
