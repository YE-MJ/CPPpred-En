...
for file_name in csv_files:
    ...
    random_search_xgb = RandomizedSearchCV(model_xgb, param_distributions_xgb, n_iter=100, scoring=mcc_scorer, cv=5, random_state=42)
...
output_file_path = "./xgboost_feature_CPP_embedding.csv"
