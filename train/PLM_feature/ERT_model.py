...
for file_name in csv_files:
    ...
    random_search_ert = RandomizedSearchCV(model_ert, param_distributions_ert, n_iter=100, scoring=mcc_scorer, cv=5, random_state=42)
...
output_file_path = "./extratrees_feature_CPP_embedding.csv"
