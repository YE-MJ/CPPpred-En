...
for file_name in csv_files:
    ...
    random_search_rf = RandomizedSearchCV(model_rf, param_distributions_rf, n_iter=100, scoring=mcc_scorer, cv=5, random_state=42)
...
output_file_path = "./randomforest_feature_CPP_embedding.csv"
